...
static uint32_t jit_cpudetect(void)
{
  ...
  flags |= JIT_F_RVC;  /* Assume RVC is always available. */
  flags |= JIT_F_RVZba;  /* Assume Zba is always available. */
  flags |= JIT_F_RVZbb;  /* Assume Zbb is always available. */
  flags |= JIT_F_RVZicond;  /* Assume Zicond is always available. */
  //flags |= JIT_F_RVZfa;  /* Assume Zfa is always available. */
